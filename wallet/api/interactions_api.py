...
class InteractionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.fetch_customer_tickets_with_token_endpoint = _Endpoint(
            settings={
                'response_type': ([Ticket],),
                'auth': [],
                'endpoint_path': '/wallet/tickets/fetchCustomerTicketsWithToken',
                'operation_id': 'fetch_customer_tickets_with_token',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def claim_ticket(
        ...
        **kwargs
        ...
        >>> thread = api.claim_ticket(id, inline_object4, async_req=True)
        >>> result = thread.get()
    ...
    def fetch_customer_tickets_with_token(
        ...
        **kwargs
        ...
        >>> thread = api.fetch_customer_tickets_with_token(inline_object5, async_req=True)
        >>> result = thread.get()
