...
class LoginAndLogoutApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.login_endpoint = _Endpoint(
            settings={
                'response_type': (WTAuthenticationLoginResponse,),
                'auth': [],
                'endpoint_path': '/authentication/login',
                'operation_id': 'login',
                'http_method': 'POST',
                'servers': None,
            },
            ...
            root_map={
                ...
                'location_map': {
                    'wt_authentication_login_request': 'body',
                },
        ...
        self.login_status_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/authentication/status/{token}',
                'operation_id': 'login_status',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.logout_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/authentication/logout',
                'operation_id': 'logout',
                'http_method': 'DELETE',
                'servers': None,
            },
    ...
    def login(
        ...
        **kwargs
        ...
        >>> thread = api.login(wt_authentication_login_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['wt_authentication_login_request'] = \
            wt_authentication_login_request
    ...
    def login_status(
        ...
        **kwargs
        ...
        >>> thread = api.login_status(token, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['token'] = \
            token
        return self.login_status_endpoint.call_with_http_info(**kwargs)
