...
class LoginAndLogoutApi:
    ...
    def login(
        ...
        :param wt_authentication_login_request: (required)
        :type wt_authentication_login_request: WTAuthenticationLoginRequest
        ...
        _param = self._login_serialize(
            wt_authentication_login_request=wt_authentication_login_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WTAuthenticationLoginResponse",
            '401': "AuthError",
            '422': "FalsumError",
    ...
    def login_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WTAuthenticationLoginResponse]:
        """Login
    ...
    def _login_serialize(
        ...
        if wt_authentication_login_request is not None:
            _body_params = wt_authentication_login_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/authentication/login',
    ...
    def login_status(
        ...
        _param = self._login_status_serialize(
            token=token,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def login_status_with_http_info(
        self,
        token: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LoginStatus200Response]:
        """Retrieve status of session token
    ...
    @validate_call
    def login_status_without_preload_content(
        self,
        token: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _login_status_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/authentication/status/{token}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _logout_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/authentication/logout',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
