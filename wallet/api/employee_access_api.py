...
class EmployeeAccessApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.register_endpoint = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/authentication/register',
            ...
            root_map={
                ...
                'location_map': {
                    'wt_authentication_register': 'body',
                },
    ...
    def register(
        ...
        **kwargs
        ...
        >>> thread = api.register(wt_authentication_register, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['wt_authentication_register'] = \
            wt_authentication_register
