...
class EmployeeAccessApi:
    ...
    def register(
        ...
        :param wt_authentication_register: (required)
        :type wt_authentication_register: WTAuthenticationRegister
        ...
        _param = self._register_serialize(
            wt_authentication_register=wt_authentication_register,
    ...
    def _register_serialize(
        ...
        if wt_authentication_register is not None:
            _body_params = wt_authentication_register
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/authentication/register',
