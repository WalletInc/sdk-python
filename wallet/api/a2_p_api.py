...
class A2PApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.fetch_a2_p_application_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/v2/a2p/application',
                'operation_id': 'fetch_a2_p_application',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.fetch_a2_p_registration_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/v2/a2p/registration',
                'operation_id': 'fetch_a2_p_registration',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def fetch_a2_p_application(
        ...
        **kwargs
        ...
        >>> thread = api.fetch_a2_p_application(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.fetch_a2_p_application_endpoint.call_with_http_info(**kwargs)
    ...
    def fetch_a2_p_registration(
        ...
        **kwargs
        ...
        >>> thread = api.fetch_a2_p_registration(async_req=True)
        >>> result = thread.get()
