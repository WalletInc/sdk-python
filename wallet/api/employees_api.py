...
class EmployeesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.fetch_profile_info_endpoint = _Endpoint(
            settings={
                'response_type': (Employee,),
                'auth': [],
                'endpoint_path': '/v2/employee',
                'operation_id': 'fetch_profile_info',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_email_notification_preference_endpoint = _Endpoint(
            settings={
                'response_type': (Employee,),
                'auth': [],
                'endpoint_path': '/v2/employee/emailNotificationPreference',
                'operation_id': 'update_email_notification_preference',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def fetch_profile_info(
        ...
        **kwargs
        ...
        >>> thread = api.fetch_profile_info(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.fetch_profile_info_endpoint.call_with_http_info(**kwargs)
    ...
    def update_email_notification_preference(
        ...
        **kwargs
        ...
        """Changes the employee's email notification preference to enabled or disabled  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_email_notification_preference(inline_object, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['inline_object'] = \
            inline_object
        return self.update_email_notification_preference_endpoint.call_with_http_info(**kwargs)
