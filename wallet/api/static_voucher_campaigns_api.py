...
class StaticVoucherCampaignsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.archive_static_voucher_campaign_endpoint = _Endpoint(
            settings={
                'response_type': (StaticVoucherCampaign,),
                'auth': [],
                'endpoint_path': '/v2/payment/staticVoucherCampaign/{campaignID}',
                'operation_id': 'archive_static_voucher_campaign',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.restore_static_voucher_campaign_endpoint = _Endpoint(
            settings={
                'response_type': (StaticVoucherCampaign,),
                'auth': [],
                'endpoint_path': '/v2/payment/staticVoucherCampaign/{campaignID}',
                'operation_id': 'restore_static_voucher_campaign',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def archive_static_voucher_campaign(
        ...
        **kwargs
        ...
        >>> thread = api.archive_static_voucher_campaign(campaign_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['campaign_id'] = \
            campaign_id
        return self.archive_static_voucher_campaign_endpoint.call_with_http_info(**kwargs)
    ...
    def create_static_voucher_campaign_with_voucher(
        ...
        **kwargs
        ...
        >>> thread = api.create_static_voucher_campaign_with_voucher(body, async_req=True)
        >>> result = thread.get()
    ...
    def restore_static_voucher_campaign(
        ...
        **kwargs
        ...
        >>> thread = api.restore_static_voucher_campaign(campaign_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['campaign_id'] = \
            campaign_id
        return self.restore_static_voucher_campaign_endpoint.call_with_http_info(**kwargs)
