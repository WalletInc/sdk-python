...
class PerformancesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.export_tickets_endpoint = _Endpoint(
            settings={
                'response_type': ([Ticket],),
                'auth': [],
                'endpoint_path': '/v2/performances/{id}/tickets/export',
                'operation_id': 'export_tickets',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.import_tickets_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/v2/performances/{id}/tickets/import',
                'operation_id': 'import_tickets',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def export_tickets(
        ...
        **kwargs
        ...
        >>> thread = api.export_tickets(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.export_tickets_endpoint.call_with_http_info(**kwargs)
    ...
    def import_tickets(
        ...
        **kwargs
        ...
        >>> thread = api.import_tickets(id, inline_object2, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['inline_object2'] = \
            inline_object2
        return self.import_tickets_endpoint.call_with_http_info(**kwargs)
