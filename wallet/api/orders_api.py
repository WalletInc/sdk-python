...
class OrdersApi:
    ...
    def redact_order_donor_note(
        ...
        _param = self._redact_order_donor_note_serialize(
            order_id=order_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def redact_order_donor_note_with_http_info(
        self,
        order_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def redact_order_donor_note_without_preload_content(
        self,
        order_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _redact_order_donor_note_serialize(
        self,
        order_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/orders/{orderId}/donor-note/redact',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
