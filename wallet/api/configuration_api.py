...
class ConfigurationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.save_merchant_credit_payment_design_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/v2/wallet/merchantCredit/paymentDesign',
                'operation_id': 'save_merchant_credit_payment_design',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def save_merchant_credit_payment_design(
        ...
        **kwargs
        ...
        >>> thread = api.save_merchant_credit_payment_design(inline_object3, async_req=True)
        >>> result = thread.get()
