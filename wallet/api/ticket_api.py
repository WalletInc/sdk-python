...
class TicketApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.archive_ticket_endpoint = _Endpoint(
            settings={
                'response_type': (Ticket,),
                'auth': [],
                'endpoint_path': '/v2/ticket/{id}',
                'operation_id': 'archive_ticket',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.fetch_ticket_endpoint = _Endpoint(
            settings={
                'response_type': (WTTicket,),
                'auth': [],
                'endpoint_path': '/v2/ticket/{id}',
                'operation_id': 'fetch_ticket',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.restore_ticket_endpoint = _Endpoint(
            settings={
                'response_type': (Ticket,),
                'auth': [],
                'endpoint_path': '/v2/ticket/{id}',
                'operation_id': 'restore_ticket',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def archive_ticket(
        ...
        **kwargs
        ...
        >>> thread = api.archive_ticket(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.archive_ticket_endpoint.call_with_http_info(**kwargs)
    ...
    def create_ticket(
        ...
        **kwargs
        ...
        >>> thread = api.create_ticket(wt_ticket_create_params, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['wt_ticket_create_params'] = \
            wt_ticket_create_params
    ...
    def fetch_ticket(
        ...
        **kwargs
        ...
        >>> thread = api.fetch_ticket(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.fetch_ticket_endpoint.call_with_http_info(**kwargs)
    ...
    def restore_ticket(
        ...
        **kwargs
        ...
        >>> thread = api.restore_ticket(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.restore_ticket_endpoint.call_with_http_info(**kwargs)
    ...
    def update_ticket(
        ...
        **kwargs
        ...
        >>> thread = api.update_ticket(id, wt_ticket_update_params, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        kwargs['wt_ticket_update_params'] = \
            wt_ticket_update_params
