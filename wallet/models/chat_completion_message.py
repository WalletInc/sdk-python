...
class ChatCompletionMessage(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[Any] = Field(description="The contents of the message.")
    refusal: Optional[Any] = Field(description="The refusal message generated by the model.")
    role: Optional[Any] = Field(description="The role of the author of this message.")
    audio: Optional[ChatCompletionMessageAudio] = None
    function_call: Optional[ChatCompletionMessageFunctionCall] = None
    tool_calls: Optional[Any] = Field(default=None, description="The tool calls generated by the model, such as function calls.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["content", "refusal", "role", "audio", "function_call", "tool_calls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "audio": ChatCompletionMessageAudio.from_dict(obj["audio"]) if obj.get("audio") is not None else None,
