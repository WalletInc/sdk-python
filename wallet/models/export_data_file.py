...
class ExportDataFile(BaseModel):
    """
    ExportDataFile
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "merchantID", "createdAt", "updatedAt", "isActive", "isRead", "employeeID", "s3Bucket", "s3Key", "fileSizeBytes"]
