...
class PickA2PApplicationSubmissionExcludeKeyofA2PApplicationSubmissionStockExchangeOrStockTickerOrBrandContactEmailOrVerificationMobile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "email", "businessClassification", "businessIndustry", "taxIDType", "taxID", "websiteURL", "socialMediaURL", "regionsOfOperation", "messagingVolumeHigh", "jobTitle", "jobPosition", "billingConsent", "businessName", "businessType", "address1", "address2", "city", "state", "postalCode", "country", "phoneNumber", "isTwilioTermsRead", "isWalletSmsTermsRead", "isPricingUnderstood", "isPrivacyAndTosPresent", "privacyPolicyUrl", "willObtainConsent", "willHonorOptOut", "willFollowContentRules", "willComplyLawAndHours", "infoIsAccurate"]
