...
class StaticVoucherCampaignGroup(BaseModel):
    """
    StaticVoucherCampaignGroup
    """ # noqa: E501
    name: StrictStr
    voucher_type: StrictInt = Field(alias="voucherType")
    ...
    __properties: ClassVar[List[str]] = ["name", "voucherType", "createdBySourceID", "employeeID", "id", "merchantID", "createdAt", "updatedAt", "isActive", "isLoaded"]
