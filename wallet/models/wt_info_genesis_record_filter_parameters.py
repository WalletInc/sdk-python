...
class WTInfoGenesisRecordFilterParameters(BaseModel):
    """
    ...
    selected_registers: Optional[Any] = Field(default=None, alias="selectedRegisters")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["startDateTime", "endDateTime", "selectedRegisters"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if selected_registers (nullable) is None
        # and model_fields_set contains the field
        if self.selected_registers is None and "selected_registers" in self.model_fields_set:
            _dict['selectedRegisters'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selectedRegisters": obj.get("selectedRegisters")
        })
