...
class PickSSOutboundMessageLogExcludeKeyofSSOutboundMessageLogToCellPhone(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "employeeID", "status", "merchantID", "createdAt", "updatedAt", "isActive", "body", "phoneNumberID", "mediaURLs", "paymentObjectBroadcastID", "bodyTemplate", "statusCallback", "isSent", "sentAt", "deliveredAt", "messageSid", "numSegments", "numMedia", "errorCode", "errorMessage"]
