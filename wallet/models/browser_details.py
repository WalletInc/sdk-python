...
class BrowserDetails(BaseModel):
    ...
    """ # noqa: E501
    ip: StrictStr
    phone_verification_token: Optional[StrictStr] = Field(default=None, alias="phoneVerificationToken")
    session_id: Optional[StrictStr] = Field(default=None, alias="sessionID")
    navigator_agent: Optional[StrictStr] = Field(default=None, alias="navigatorAgent")
