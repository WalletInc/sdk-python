...
class Document(BaseModel):
    ...
    file_url: Optional[Any] = Field(description="The URL of the file", alias="fileURL")
    file_type: Optional[Any] = Field(description="The type of the file", alias="fileType")
    file_name: Optional[Any] = Field(description="The name of the file", alias="fileName")
    file_size: Optional[Any] = Field(description="The size of the file", alias="fileSize")
    folder: Optional[Any] = Field(description="The folder in which the file is stored")
