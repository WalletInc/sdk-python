...
class PickVSAdvertisementCreditScanExcludeKeyofVSAdvertisementCreditScanRedeemedAtOrRefundedAt(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "transactionType", "registerID", "redeemedSource", "redeemedTransactionID", "redeemedAmount", "isRedeemed", "refundedTransactionID", "refundedAmount", "status", "authorizedAgainstCheckNumber", "authorizedAmount", "merchantID", "createdAt", "updatedAt", "isActive", "advertisementCreditID"]
