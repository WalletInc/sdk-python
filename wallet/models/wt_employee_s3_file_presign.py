...
class WTEmployeeS3FilePresign(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["fileName", "fileType", "context"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "context": WTEmployeeS3FilePresignContext.from_dict(obj["context"]) if obj.get("context") is not None else None
        })
