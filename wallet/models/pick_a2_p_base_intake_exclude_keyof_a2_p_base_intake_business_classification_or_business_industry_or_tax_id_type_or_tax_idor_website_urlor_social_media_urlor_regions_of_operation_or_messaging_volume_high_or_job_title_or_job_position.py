...
class PickA2PBaseIntakeExcludeKeyofA2PBaseIntakeBusinessClassificationOrBusinessIndustryOrTaxIDTypeOrTaxIDOrWebsiteURLOrSocialMediaURLOrRegionsOfOperationOrMessagingVolumeHighOrJobTitleOrJobPosition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "email", "businessName", "businessType", "address1", "address2", "city", "state", "postalCode", "country", "phoneNumber", "isTwilioTermsRead", "isWalletSmsTermsRead", "isPricingUnderstood", "isPrivacyAndTosPresent", "privacyPolicyUrl", "willObtainConsent", "willHonorOptOut", "willFollowContentRules", "willComplyLawAndHours", "infoIsAccurate"]
