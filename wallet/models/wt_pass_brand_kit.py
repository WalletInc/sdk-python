...
class WTPassBrandKit(BaseModel):
    """
    WTPassBrandKit
    """ # noqa: E501
    ...
    accent_color: Optional[Any] = Field(default=None, alias="accentColor")
    logo_url: Optional[Any] = Field(default=None, alias="logoUrl")
    mark_url: Optional[Any] = Field(default=None, alias="markUrl")
    banner_image_url: Optional[Any] = Field(default=None, alias="bannerImageUrl")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["backgroundColor", "textColor", "accentColor", "logoUrl", "markUrl", "bannerImageUrl"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if mark_url (nullable) is None
        # and model_fields_set contains the field
        if self.mark_url is None and "mark_url" in self.model_fields_set:
            _dict['markUrl'] = None

        # set to None if banner_image_url (nullable) is None
        # and model_fields_set contains the field
        if self.banner_image_url is None and "banner_image_url" in self.model_fields_set:
            _dict['bannerImageUrl'] = None
