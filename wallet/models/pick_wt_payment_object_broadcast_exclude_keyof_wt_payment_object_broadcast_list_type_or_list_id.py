...
class PickWTPaymentObjectBroadcastExcludeKeyofWTPaymentObjectBroadcastListTypeOrListID(BaseModel):
    ...
    broadcast_queued_at: datetime = Field(alias="broadcastQueuedAt")
    broadcast_started_at: datetime = Field(alias="broadcastStartedAt")
    broadcast_completed_at: datetime = Field(alias="broadcastCompletedAt")
