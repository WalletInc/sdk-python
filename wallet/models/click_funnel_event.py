...
class ClickFunnelEvent(BaseModel):
    """
    ClickFunnelEvent
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["purchase", "event"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "purchase": ClickFunnelPurchase.from_dict(obj["purchase"]) if obj.get("purchase") is not None else None,
            "event": obj.get("event")
        })
