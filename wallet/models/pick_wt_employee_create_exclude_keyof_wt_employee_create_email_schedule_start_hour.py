...
PICKWTEMPLOYEECREATEEXCLUDEKEYOFWTEMPLOYEECREATEEMAILSCHEDULESTARTHOUR_ANY_OF_SCHEMAS = ["float"]

class PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartHour(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartHour.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartHour with anyOf schemas: float. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartHour with anyOf schemas: float. Details: " + ", ".join(error_messages))
        else:
            return instance
