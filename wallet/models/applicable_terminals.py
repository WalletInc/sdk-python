...
APPLICABLETERMINALS_ANY_OF_SCHEMAS = ["str"]

class ApplicableTerminals(BaseModel):
    """
    ApplicableTerminals
    """
    ...
    # data type: str
    anyof_schema_7_validator: Optional[StrictStr] = None
    if TYPE_CHECKING:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ApplicableTerminals.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ApplicableTerminals with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ApplicableTerminals with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
