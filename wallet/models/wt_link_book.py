...
class WTLinkBook(BaseModel):
    ...
    link_book_section_id: Optional[WTLinkBookLinkBookSectionID] = Field(default=None, alias="linkBookSectionID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "linkBookSectionID": WTLinkBookLinkBookSectionID.from_dict(obj["linkBookSectionID"]) if obj.get("linkBookSectionID") is not None else None,
