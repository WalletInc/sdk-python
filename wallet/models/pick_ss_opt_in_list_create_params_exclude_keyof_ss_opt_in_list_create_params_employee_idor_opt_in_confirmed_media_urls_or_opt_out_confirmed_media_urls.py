...
class PickSSOptInListCreateParamsExcludeKeyofSSOptInListCreateParamsEmployeeIDOrOptInConfirmedMediaURLsOrOptOutConfirmedMediaURLs(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["isActive", "listName", "phoneNumberID", "estimatedMessagesPerMonth", "optInKeyword", "optOutKeyword", "optInConfirmedResponse", "optOutConfirmedResponse", "optInConfirmedCustomerReceives", "optOutConfirmedCustomerReceives", "isOver21Required"]
