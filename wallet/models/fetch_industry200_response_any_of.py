...
class FetchIndustry200ResponseAnyOf(BaseModel):
    """
    ...
    title: StrictStr
    icon: StrictStr
    sort_number: StrictStr = Field(alias="sortNumber")
    id: StrictStr
    __properties: ClassVar[List[str]] = ["plans", "title", "icon", "sortNumber", "id"]
