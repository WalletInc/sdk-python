...
class PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmail(BaseModel):
    """
    ...
    schedule_start_minute: Optional[PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartMinute] = Field(default=None, alias="scheduleStartMinute")
    schedule_start_meridiem: Optional[PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartMeridiem] = Field(default=None, alias="scheduleStartMeridiem")
    schedule_end_day: Optional[PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartDay] = Field(default=None, alias="scheduleEndDay")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scheduleStartMinute": PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartMinute.from_dict(obj["scheduleStartMinute"]) if obj.get("scheduleStartMinute") is not None else None,
            "scheduleStartMeridiem": PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartMeridiem.from_dict(obj["scheduleStartMeridiem"]) if obj.get("scheduleStartMeridiem") is not None else None,
            "scheduleEndDay": PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartDay.from_dict(obj["scheduleEndDay"]) if obj.get("scheduleEndDay") is not None else None,
            "scheduleEndHour": PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartHour.from_dict(obj["scheduleEndHour"]) if obj.get("scheduleEndHour") is not None else None,
            "scheduleEndMinute": PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartMinute.from_dict(obj["scheduleEndMinute"]) if obj.get("scheduleEndMinute") is not None else None,
            "scheduleEndMeridiem": PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmailScheduleStartMeridiem.from_dict(obj["scheduleEndMeridiem"]) if obj.get("scheduleEndMeridiem") is not None else None
        })
        return _obj
