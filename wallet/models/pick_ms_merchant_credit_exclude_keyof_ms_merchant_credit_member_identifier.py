...
class PickMSMerchantCreditExcludeKeyofMSMerchantCreditMemberIdentifier(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "merchantID", "createdAt", "updatedAt", "isActive", "mobileNumber", "creditAmount"]
