...
class NewsArticle(BaseModel):
    ...
    published_date: Optional[Any] = Field(default=None, alias="publishedDate")
    id: AmenityId
    ...
    __properties: ClassVar[List[str]] = ["title", "orderNumber", "body", "url", "mediaURL", "publishedDate", "id", "createdAt", "updatedAt", "isActive", "merchantID"]
