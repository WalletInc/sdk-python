...
from wallet.models.employee_chrome_theme import EmployeeChromeTheme
...
class WTEmployee(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of chrome_theme
        if self.chrome_theme:
            _dict['chromeTheme'] = self.chrome_theme.to_dict()
        ...
        # set to None if is_page_tips_disabled (nullable) is None
        # and model_fields_set contains the field
        if self.is_page_tips_disabled is None and "is_page_tips_disabled" in self.model_fields_set:
            _dict['isPageTipsDisabled'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chromeTheme": EmployeeChromeTheme.from_dict(obj["chromeTheme"]) if obj.get("chromeTheme") is not None else None,
            "isPageTipsDisabled": obj.get("isPageTipsDisabled")
        })
