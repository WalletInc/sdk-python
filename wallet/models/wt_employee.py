...
class WTEmployee(BaseModel):
    ...
    username: StrictStr
    email_verified: StrictStr = Field(alias="emailVerified")
    ...
    failed_login_attempts: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="failedLoginAttempts")
    last_login_date: Optional[datetime] = Field(default=None, alias="lastLoginDate")
    cfuvid: Optional[StrictStr] = None
    schedule: Optional[Dict[str, Any]] = None
    is_email_notification_disabled: Optional[StrictBool] = Field(default=None, alias="isEmailNotificationDisabled")
