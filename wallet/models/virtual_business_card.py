...
class VirtualBusinessCard(BaseModel):
    ...
    tik_tok: Optional[Any] = Field(default=None, alias="tikTok")
    ...
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "emailAddress", "designation", "phoneNumber", "introduction", "instagram", "facebook", "youTube", "twitter", "linkedIn", "tikTok", "whatsApp", "avatarURL", "id", "createdAt", "updatedAt", "isActive", "merchantID"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if tik_tok (nullable) is None
        # and model_fields_set contains the field
        if self.tik_tok is None and "tik_tok" in self.model_fields_set:
            _dict['tikTok'] = None
