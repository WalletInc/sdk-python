...
class WTEmployeeScheduleSimpleSMSToRecipient(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if to_cell_phone (nullable) is None
        # and model_fields_set contains the field
        if self.to_cell_phone is None and "to_cell_phone" in self.model_fields_set:
            _dict['toCellPhone'] = None
