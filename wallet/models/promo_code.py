...
class PromoCode(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "promoCode", "displayValue", "orderNumber", "mediaURL", "startDate", "expirationDate", "id", "createdAt", "updatedAt", "isActive", "merchantID"]
