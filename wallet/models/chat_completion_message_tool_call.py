...
class ChatCompletionMessageToolCall(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[Any] = Field(description="The ID of the tool call.")
    function: ChatCompletionMessageToolCallFunction = Field(description="The function that the model called.")
    type: Optional[Any] = Field(description="The type of the tool. Currently, only `function` is supported.")
