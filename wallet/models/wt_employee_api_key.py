...
class WTEmployeeAPIKey(BaseModel):
    """
    WTEmployeeAPIKey
    """ # noqa: E501
    ...
    api_key: Optional[Any] = Field(default=None, description="The API Key that is generated by the server. This will be sent only once after creation of an API Key in the response. Will always be empty otherwise.", alias="apiKey")
