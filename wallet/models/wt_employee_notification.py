...
class WTEmployeeNotification(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "title", "content", "payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": WTEmployeeNotificationType.from_dict(obj["type"]) if obj.get("type") is not None else None,
            "title": obj.get("title"),
