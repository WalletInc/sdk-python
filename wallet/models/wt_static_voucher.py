...
class WTStaticVoucher(BaseModel):
    """
    WTStaticVoucher
    """ # noqa: E501
    id: StaticVoucherId
    ...
    offer_amount_cents_decimal: Optional[Any] = Field(alias="offerAmountCents_decimal")
    offer_amount_cents_string: Optional[Any] = Field(alias="offerAmountCents_string")
    ...
    date_time_redeemed: Optional[Any] = Field(default=None, alias="dateTimeRedeemed")
    date_time_refunded: Optional[Any] = Field(default=None, alias="dateTimeRefunded")
    date_time_last_viewed: Optional[Any] = Field(default=None, alias="dateTimeLastViewed")
    reason_invalid: Optional[Any] = Field(default=None, alias="reasonInvalid")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if offer_amount_cents_decimal (nullable) is None
        # and model_fields_set contains the field
        if self.offer_amount_cents_decimal is None and "offer_amount_cents_decimal" in self.model_fields_set:
            _dict['offerAmountCents_decimal'] = None

        # set to None if offer_amount_cents_string (nullable) is None
        # and model_fields_set contains the field
        if self.offer_amount_cents_string is None and "offer_amount_cents_string" in self.model_fields_set:
            _dict['offerAmountCents_string'] = None
        ...
        # set to None if reason_invalid (nullable) is None
        # and model_fields_set contains the field
        if self.reason_invalid is None and "reason_invalid" in self.model_fields_set:
            _dict['reasonInvalid'] = None
