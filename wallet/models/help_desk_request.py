...
class HelpDeskRequest(BaseModel):
    ...
    HelpDeskRequest
    """ # noqa: E501
    merchant_phone_number_id: Annotated[str, Field(min_length=10, strict=True, max_length=10)] = Field(alias="merchantPhoneNumberID")
    cell_phone: Optional[Any] = Field(alias="cellPhone")
    id: StaticVoucherId
    ...
    is_resolved: Optional[Any] = Field(alias="isResolved")
    resolved_at: Optional[Any] = Field(default=None, alias="resolvedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["merchantPhoneNumberID", "cellPhone", "id", "merchantID", "createdAt", "updatedAt", "isActive", "employeeID", "isResolved", "resolvedAt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if self.is_resolved is None and "is_resolved" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "merchantPhoneNumberID": obj.get("merchantPhoneNumberID"),
