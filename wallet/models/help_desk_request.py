...
class HelpDeskRequest(BaseModel):
    ...
    cell_phone: StrictStr = Field(alias="cellPhone")
    ...
    is_resolved: StrictBool = Field(alias="isResolved")
    ...
    @field_validator('merchant_phone_number_id')
    def merchant_phone_number_id_validate_regular_expression(cls, value):
