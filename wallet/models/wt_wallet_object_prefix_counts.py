...
class WTWalletObjectPrefixCounts(BaseModel):
    ...
    wallet_object_name: StrictStr = Field(alias="walletObjectName")
    list: List[WTWalletPageViewCount]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [WTWalletPageViewCount.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
