...
class WTEmployeeCreateMediaFile(BaseModel):
    """
    WTEmployeeCreateMediaFile
    """ # noqa: E501
    file_name: Optional[Any] = Field(alias="fileName")
    file_data: Optional[Any] = Field(alias="fileData")
    folder: Optional[Any] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["fileName", "fileData", "folder"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if file_data (nullable) is None
        # and model_fields_set contains the field
        if self.file_data is None and "file_data" in self.model_fields_set:
            _dict['fileData'] = None
