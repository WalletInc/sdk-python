...
class PickWTEmailSubscriberUpdateParamsExcludeKeyofWTEmailSubscriberUpdateParamsId(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "emailAddress"]
