...
class UpdateStaticVoucherCampaignWithVoucher(BaseModel):
    ...
    voucher_id: UpdateStaticVoucherCampaignWithVoucherVoucherID = Field(alias="voucherID")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.voucher_id:
            _dict['voucherID'] = self.voucher_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "voucherID": UpdateStaticVoucherCampaignWithVoucherVoucherID.from_dict(obj["voucherID"]) if obj.get("voucherID") is not None else None
        })
        return _obj
