...
class MSMembershipTierRedemption(BaseModel):
    ...
    """ # noqa: E501
    member_id: Annotated[str, Field(min_length=10, strict=True, max_length=10)] = Field(description="A 10 character alphanumeric unique value that represents each member", alias="memberID")
    ...
    amount: Annotated[int, Field(strict=True, ge=0)] = Field(description="The amount that has been redeemed, in cents")
    ...
    tier_id: Annotated[str, Field(min_length=10, strict=True, max_length=10)] = Field(description="A 10 character alphanumeric unique value that represents each membership tier", alias="tierID")
