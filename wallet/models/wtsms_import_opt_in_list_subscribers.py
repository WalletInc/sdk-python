...
class WTSMSImportOptInListSubscribers(BaseModel):
    """
    WTSMSImportOptInListSubscribers
    """ # noqa: E501
    file_name: Optional[Any] = Field(alias="fileName")
    bucket: Optional[Any]
    opt_in_source_id: Annotated[str, Field(min_length=10, strict=True, max_length=10)] = Field(alias="optInSourceID")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["fileName", "bucket", "optInSourceID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "optInSourceID": obj.get("optInSourceID")
        })
