...
class WTPromoCodeCreateParams(BaseModel):
    ...
    promo_code: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="promoCode")
    display_value: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="displayValue")
