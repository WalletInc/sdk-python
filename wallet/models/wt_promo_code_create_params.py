...
class WTPromoCodeCreateParams(BaseModel):
    """
    WTPromoCodeCreateParams
    """ # noqa: E501
    title: Optional[Any]
    description: Optional[Any]
    promo_code: Optional[Any] = Field(alias="promoCode")
    display_value: Optional[Any] = Field(alias="displayValue")
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "promoCode", "displayValue", "orderNumber", "mediaURL", "startDate", "expirationDate"]
