...
class CreateStaticVoucherCampaign(BaseModel):
    ...
    bucket: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    file_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="fileName")
    source_id: StrictInt = Field(alias="sourceID")
    campaign_group_id: Optional[SaveTicketSettingsRequestPaymentDesignID] = Field(default=None, alias="campaignGroupID")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of campaign_group_id
        if self.campaign_group_id:
            _dict['campaignGroupID'] = self.campaign_group_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "campaignGroupID": SaveTicketSettingsRequestPaymentDesignID.from_dict(obj["campaignGroupID"]) if obj.get("campaignGroupID") is not None else None
        })
        return _obj
