...
class PickPaginationRequestWithoutSortOptionsExcludeKeyofPaginationRequestWithoutSortOptionsIsArchiveIncluded(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pageSize", "pageNum"]
