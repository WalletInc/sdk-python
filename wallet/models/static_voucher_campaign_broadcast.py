...
class StaticVoucherCampaignBroadcast(BaseModel):
    """
    ...
    static_voucher_campaign: StaticVoucherCampaign = Field(alias="StaticVoucherCampaign")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "employeeID", "merchantID", "createdAt", "updatedAt", "isActive", "phoneNumberID", "mediaURLs", "OptInList", "ImportedList", "broadcastStatus", "broadcastQueuedAt", "broadcastStartedAt", "broadcastCompletedAt", "paymentObjectPrefix", "paymentObjectID", "messageTemplate", "broadcastScheduledAt", "StaticVoucherCampaign"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of static_voucher_campaign
        if self.static_voucher_campaign:
            _dict['StaticVoucherCampaign'] = self.static_voucher_campaign.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "StaticVoucherCampaign": StaticVoucherCampaign.from_dict(obj["StaticVoucherCampaign"]) if obj.get("StaticVoucherCampaign") is not None else None
        })
