...
class MerchantURL(BaseModel):
    """
    MerchantURL
    """ # noqa: E501
    nickname: Optional[Any]
    destination_url: Optional[Any] = Field(alias="destinationURL")
    id: AmenityId
    ...
    __properties: ClassVar[List[str]] = ["nickname", "destinationURL", "id", "createdAt", "updatedAt", "merchantID", "isActive"]
