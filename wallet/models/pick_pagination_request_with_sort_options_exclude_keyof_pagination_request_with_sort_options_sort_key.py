...
class PickPaginationRequestWithSortOptionsExcludeKeyofPaginationRequestWithSortOptionsSortKey(BaseModel):
    ...
    sort_order: Optional[PickPaginationRequestWithSortOptionsExcludeKeyofPaginationRequestWithSortOptionsSortKeySortOrder] = Field(default=None, alias="sortOrder")
    __properties: ClassVar[List[str]] = ["isArchiveIncluded", "pageNum", "pageSize", "sortOrder"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sortOrder": PickPaginationRequestWithSortOptionsExcludeKeyofPaginationRequestWithSortOptionsSortKeySortOrder.from_dict(obj["sortOrder"]) if obj.get("sortOrder") is not None else None
        })
        return _obj
