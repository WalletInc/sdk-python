...
class PickSSImportedListUpdateParamsExcludeKeyofSSImportedListUpdateParamsId(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["employeeID", "isActive", "listName", "phoneNumberID"]
