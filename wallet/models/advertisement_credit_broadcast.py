...
class AdvertisementCreditBroadcast(BaseModel):
    """
    ...
    advertisement_credit: AdvertisementCredit = Field(alias="AdvertisementCredit")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["phoneNumberID", "paymentObjectPrefix", "paymentObjectID", "messageTemplate", "mediaURLs", "employeeID", "broadcastScheduledAt", "id", "merchantID", "createdAt", "updatedAt", "isActive", "broadcastStatus", "broadcastQueuedAt", "broadcastStartedAt", "broadcastCompletedAt", "listType", "listID", "OptInList", "ImportedList", "AdvertisementCredit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of advertisement_credit
        if self.advertisement_credit:
            _dict['AdvertisementCredit'] = self.advertisement_credit.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AdvertisementCredit": AdvertisementCredit.from_dict(obj["AdvertisementCredit"]) if obj.get("AdvertisementCredit") is not None else None
        })
