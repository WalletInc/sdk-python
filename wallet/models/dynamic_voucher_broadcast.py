...
class DynamicVoucherBroadcast(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of dynamic_voucher
        if self.dynamic_voucher:
            _dict['DynamicVoucher'] = self.dynamic_voucher.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DynamicVoucher": DynamicVoucher.from_dict(obj["DynamicVoucher"]) if obj.get("DynamicVoucher") is not None else None
        })
