...
class WTAuthenticationLoginResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created_at, updated_at, first_name, last_name, username, email, merchant_id, employee_id, profile_picture_url, job_title, department, merchant_name, merchant_industry, *args, **kwargs):  # noqa: E501
        """WTAuthenticationLoginResponse - a model defined in OpenAPI
        ...
        self.merchant_industry = merchant_industry
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created_at, updated_at, first_name, last_name, username, email, merchant_id, employee_id, profile_picture_url, job_title, department, merchant_name, merchant_industry, *args, **kwargs):  # noqa: E501
        """WTAuthenticationLoginResponse - a model defined in OpenAPI
