...
class WTImportedList(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, employee_id, is_active, list_name, phone_number_id, id, merchant_id, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """WTImportedList - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, employee_id, is_active, list_name, phone_number_id, id, merchant_id, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """WTImportedList - a model defined in OpenAPI
