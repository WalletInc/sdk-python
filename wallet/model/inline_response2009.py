...
class InlineResponse2009(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, payment_design, value_type, voucher_type, expiration_date, start_date, title, is_redeemed, offer_amount_cents_decimal, offer_amount_cents, member_id, cell_phone_number, id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, payment_design, value_type, voucher_type, expiration_date, start_date, title, is_redeemed, offer_amount_cents_decimal, offer_amount_cents, member_id, cell_phone_number, id, *args, **kwargs):  # noqa: E501
        """InlineResponse2009 - a model defined in OpenAPI
