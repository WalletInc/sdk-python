...
class WTOutboundStatuses(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """WTOutboundStatuses - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (SSOutboundStatuses):  # noqa: E501

        Keyword Args:
            value (SSOutboundStatuses):  # noqa: E501
