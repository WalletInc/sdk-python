...
class PickWTPaymentObjectBroadcastExcludeKeyofWTPaymentObjectBroadcastListTypeOrListID(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, employee_id, is_active, merchant_id, created_at, updated_at, phone_number_id, media_urls, broadcast_status, broadcast_queued_at, broadcast_started_at, broadcast_completed_at, payment_object_prefix, payment_object_id, message_template, broadcast_scheduled_at, *args, **kwargs):  # noqa: E501
        """PickWTPaymentObjectBroadcastExcludeKeyofWTPaymentObjectBroadcastListTypeOrListID - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, employee_id, is_active, merchant_id, created_at, updated_at, phone_number_id, media_urls, broadcast_status, broadcast_queued_at, broadcast_started_at, broadcast_completed_at, payment_object_prefix, payment_object_id, message_template, broadcast_scheduled_at, *args, **kwargs):  # noqa: E501
        """PickWTPaymentObjectBroadcastExcludeKeyofWTPaymentObjectBroadcastListTypeOrListID - a model defined in OpenAPI
