...
class LinkBookSection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, order_number, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
        """LinkBookSection - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, order_number, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
        """LinkBookSection - a model defined in OpenAPI
