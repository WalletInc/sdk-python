...
class Merchant(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'marketing_contact_employee_id': (str,),  # noqa: E501
            'technical_contact_employee_id': (str,),  # noqa: E501
            'customer_service_contact_employee_id': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'marketing_contact_employee_id': 'marketingContactEmployeeID',  # noqa: E501
        'technical_contact_employee_id': 'technicalContactEmployeeID',  # noqa: E501
        'customer_service_contact_employee_id': 'customerServiceContactEmployeeID',  # noqa: E501
    ...
    def _from_openapi_data(cls, company_name, address1, address2, city, state, country, phone_number, zip, id, created_at, updated_at, industry, industry_name, info_genesis_property_id, is_frozen, billing_contact_employee_id, marketing_contact_employee_id, technical_contact_employee_id, customer_service_contact_employee_id, stripe_customer_id, is_payment_method_provided, plan_nickname, max_sms_count, *args, **kwargs):  # noqa: E501
        ...
        self.marketing_contact_employee_id = marketing_contact_employee_id
        self.technical_contact_employee_id = technical_contact_employee_id
        self.customer_service_contact_employee_id = customer_service_contact_employee_id
