...
class SubscriptionPlan(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'examples': (str,),  # noqa: E501
            'products': ([SubscriptionProduct],),  # noqa: E501
            'all_pages': ([PortalPage],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, price, nickname, examples, products, all_pages, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, price, nickname, examples, products, all_pages, *args, **kwargs):  # noqa: E501
        """SubscriptionPlan - a model defined in OpenAPI
