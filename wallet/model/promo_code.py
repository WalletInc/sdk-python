...
class PromoCode(ModelNormal):
    ...
    attribute_map = {
        ...
        'promo_code': 'promoCode',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, description, promo_code, display_value, order_number, start_date, expiration_date, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, description, promo_code, display_value, order_number, start_date, expiration_date, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
        """PromoCode - a model defined in OpenAPI
