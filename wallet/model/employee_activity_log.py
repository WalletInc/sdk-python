...
class EmployeeActivityLog(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created_at, updated_at, employee_id, action, route, page_name, *args, **kwargs):  # noqa: E501
        """EmployeeActivityLog - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created_at, updated_at, employee_id, action, route, page_name, *args, **kwargs):  # noqa: E501
        """EmployeeActivityLog - a model defined in OpenAPI
