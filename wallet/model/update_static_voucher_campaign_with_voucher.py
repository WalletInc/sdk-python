...
class UpdateStaticVoucherCampaignWithVoucher(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, notes, value_type, payment_design_id, start_date_time, expiration_date_time, offer_amount_cents, voucher_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, notes, value_type, payment_design_id, start_date_time, expiration_date_time, offer_amount_cents, voucher_id, *args, **kwargs):  # noqa: E501
        """UpdateStaticVoucherCampaignWithVoucher - a model defined in OpenAPI
