...
class Announcement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created_at, updated_at, subject, body, severity, is_active, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created_at, updated_at, subject, body, severity, is_active, *args, **kwargs):  # noqa: E501
        """Announcement - a model defined in OpenAPI
