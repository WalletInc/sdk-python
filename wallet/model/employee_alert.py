...
class EmployeeAlert(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            's3_bucket': (str,),  # noqa: E501
            's3_key': (str,),  # noqa: E501
            'file_size_bytes': (float,),  # noqa: E501
            'id': (NanoID,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, employee_id, title, message, s3_bucket, s3_key, file_size_bytes, id, created_at, updated_at, is_read, *args, **kwargs):  # noqa: E501
        """EmployeeAlert - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, employee_id, title, message, s3_bucket, s3_key, file_size_bytes, id, created_at, updated_at, is_read, *args, **kwargs):  # noqa: E501
        """EmployeeAlert - a model defined in OpenAPI
