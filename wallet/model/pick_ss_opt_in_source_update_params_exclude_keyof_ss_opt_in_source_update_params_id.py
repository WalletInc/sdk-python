...
class PickSSOptInSourceUpdateParamsExcludeKeyofSSOptInSourceUpdateParamsId(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, employee_id, list_id, source_name, *args, **kwargs):  # noqa: E501
        """PickSSOptInSourceUpdateParamsExcludeKeyofSSOptInSourceUpdateParamsId - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, employee_id, list_id, source_name, *args, **kwargs):  # noqa: E501
        """PickSSOptInSourceUpdateParamsExcludeKeyofSSOptInSourceUpdateParamsId - a model defined in OpenAPI
