...
class ImageGrid(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, url, media_url, sequence_number, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
        """ImageGrid - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            is_pinned (bool): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, url, media_url, sequence_number, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
        """ImageGrid - a model defined in OpenAPI
