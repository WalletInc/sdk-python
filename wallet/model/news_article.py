...
class NewsArticle(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, order_number, body, url, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, order_number, body, url, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
        """NewsArticle - a model defined in OpenAPI
