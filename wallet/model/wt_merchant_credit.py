...
class WTMerchantCredit(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, merchant_id, created_at, updated_at, is_active, mobile_number, credit_amount, credit_amount_decimal, credit_amount_string, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, merchant_id, created_at, updated_at, is_active, mobile_number, credit_amount, credit_amount_decimal, credit_amount_string, *args, **kwargs):  # noqa: E501
        """WTMerchantCredit - a model defined in OpenAPI
