...
class WTPromoCodeCreateParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, description, promo_code, display_value, order_number, start_date, expiration_date, *args, **kwargs):  # noqa: E501
        """WTPromoCodeCreateParams - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, description, promo_code, display_value, order_number, start_date, expiration_date, *args, **kwargs):  # noqa: E501
        """WTPromoCodeCreateParams - a model defined in OpenAPI
