...
class Product(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, title, title_full, category, icon_name, description, plans, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, title, title_full, category, icon_name, description, plans, *args, **kwargs):  # noqa: E501
        """Product - a model defined in OpenAPI
