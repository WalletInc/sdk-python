...
class InlineResponse200(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'plans': ([SubscriptionPlan],),  # noqa: E501
            'title': (str,),  # noqa: E501
            'icon': (str,),  # noqa: E501
            'sort_number': (str,),  # noqa: E501
            'id': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'icon': 'icon',  # noqa: E501
        'sort_number': 'sortNumber',  # noqa: E501
        'id': 'id',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, plans, title, icon, sort_number, id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, plans, title, icon, sort_number, id, *args, **kwargs):  # noqa: E501
        """InlineResponse200 - a model defined in OpenAPI
