...
class WTNewsArticleUpdateParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, body, url, order_number, *args, **kwargs):  # noqa: E501
        """WTNewsArticleUpdateParams - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, body, url, order_number, *args, **kwargs):  # noqa: E501
        """WTNewsArticleUpdateParams - a model defined in OpenAPI
