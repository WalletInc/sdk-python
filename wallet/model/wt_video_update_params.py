...
class WTVideoUpdateParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, description, order_number, media_url, *args, **kwargs):  # noqa: E501
        """WTVideoUpdateParams - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, description, order_number, media_url, *args, **kwargs):  # noqa: E501
        """WTVideoUpdateParams - a model defined in OpenAPI
