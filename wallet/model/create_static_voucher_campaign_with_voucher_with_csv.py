...
class CreateStaticVoucherCampaignWithVoucherWithCSV(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'campaign_group_id': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, start_date_time, expiration_date_time, title, notes, value_type, payment_design_id, is_active, bucket, file_name, source_id, *args, **kwargs):  # noqa: E501
        """CreateStaticVoucherCampaignWithVoucherWithCSV - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            campaign_group_id (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, start_date_time, expiration_date_time, title, notes, value_type, payment_design_id, is_active, bucket, file_name, source_id, *args, **kwargs):  # noqa: E501
        """CreateStaticVoucherCampaignWithVoucherWithCSV - a model defined in OpenAPI
