...
class WTFetchWalletPaymentObjectWithToken(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, phone_verification_token, merchant_id, page_type, *args, **kwargs):  # noqa: E501
        """WTFetchWalletPaymentObjectWithToken - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, phone_verification_token, merchant_id, page_type, *args, **kwargs):  # noqa: E501
        """WTFetchWalletPaymentObjectWithToken - a model defined in OpenAPI
