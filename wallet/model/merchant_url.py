...
class MerchantURL(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, nickname, destination_url, id, created_at, updated_at, merchant_id, is_active, *args, **kwargs):  # noqa: E501
        """MerchantURL - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, nickname, destination_url, id, created_at, updated_at, merchant_id, is_active, *args, **kwargs):  # noqa: E501
        """MerchantURL - a model defined in OpenAPI
