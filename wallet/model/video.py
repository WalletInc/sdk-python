...
class Video(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, description, order_number, media_url, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, description, order_number, media_url, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
        """Video - a model defined in OpenAPI
