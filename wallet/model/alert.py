...
class Alert(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created_at, updated_at, title, message, is_read, s3_bucket, s3_key, file_size_bytes, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created_at, updated_at, title, message, is_read, s3_bucket, s3_key, file_size_bytes, *args, **kwargs):  # noqa: E501
        """Alert - a model defined in OpenAPI
