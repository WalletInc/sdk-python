...
class StaticVoucherCampaignUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, start_date_time, expiration_date_time, title, notes, value_type, payment_design_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, start_date_time, expiration_date_time, title, notes, value_type, payment_design_id, *args, **kwargs):  # noqa: E501
        """StaticVoucherCampaignUpdate - a model defined in OpenAPI
