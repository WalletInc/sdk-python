...
class SSOptInSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, list_id, source_name, employee_id, merchant_id, created_at, updated_at, is_active, *args, **kwargs):  # noqa: E501
        """SSOptInSource - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, list_id, source_name, employee_id, merchant_id, created_at, updated_at, is_active, *args, **kwargs):  # noqa: E501
        """SSOptInSource - a model defined in OpenAPI
