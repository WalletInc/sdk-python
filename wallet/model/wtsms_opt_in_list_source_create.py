...
class WTSMSOptInListSourceCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, list_id, source_name, *args, **kwargs):  # noqa: E501
        """WTSMSOptInListSourceCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, list_id, source_name, *args, **kwargs):  # noqa: E501
        """WTSMSOptInListSourceCreate - a model defined in OpenAPI
