...
class PickMSMemberExcludeKeyofMSMemberMemberIdentifier(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, merchant_id, created_at, updated_at, is_active, membership_tier_id, mobile_number, points_accrued, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, merchant_id, created_at, updated_at, is_active, membership_tier_id, mobile_number, points_accrued, *args, **kwargs):  # noqa: E501
        """PickMSMemberExcludeKeyofMSMemberMemberIdentifier - a model defined in OpenAPI
