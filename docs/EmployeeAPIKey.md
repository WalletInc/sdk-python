...
**updated_at** | **datetime** |  | 
**is_active** | **bool** |  | 
**api_key** | **object** | The API Key that is generated by the server. This will be sent only once after creation of an API Key in the response. Will always be empty otherwise. | [optional] 
