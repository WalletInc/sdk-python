...
with wallet.ApiClient(configuration) as api_client:
    ...
    api_instance = wallet.WixTerminalApi(api_client)
...
> object redeem_wallet_item_from_wix_terminal(item_id, wt_wallet_item_redemption)
...
with wallet.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WixTerminalApi->redeem_wallet_item_from_wix_terminal:\n")
        pprint(api_response)
    except Exception as e:
...
> object refund_wallet_item_from_wix_terminal(ledger_entry_id)
...
with wallet.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WixTerminalApi->refund_wallet_item_from_wix_terminal:\n")
        pprint(api_response)
    except Exception as e:
