# wallet.WalletTransactionLedgerApi

All URIs are relative to *https://api.wall.et*

Method | HTTP request | Description
------------- | ------------- | -------------
[**fetch_all_ledger_transactions**](WalletTransactionLedgerApi.md#fetch_all_ledger_transactions) | **GET** /v2/pos/ledger/transactions/all | Get ledger entries
...
with wallet.ApiClient(configuration) as api_client:
    ...
    api_instance = wallet.WalletTransactionLedgerApi(api_client)
    ...
    try:
        ...
        print("The response of WalletTransactionLedgerApi->fetch_all_ledger_transactions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WalletTransactionLedgerApi->fetch_all_ledger_transactions: %s\n" % e)
```
