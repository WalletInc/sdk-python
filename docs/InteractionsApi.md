...
[**create_guest_donation**](InteractionsApi.md#create_guest_donation) | **POST** /wallet/payments/donate | Create a guest tip / donation PaymentIntent (KAN-861)
...
# **create_guest_donation**
> WTGuestCreatePaymentIntentResponse create_guest_donation(wt_guest_donation_request)

Create a guest tip / donation PaymentIntent (KAN-861)
...
with wallet.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = wallet.InteractionsApi(api_client)
    wt_guest_donation_request = wallet.WTGuestDonationRequest() # WTGuestDonationRequest | 

    try:
        # Create a guest tip / donation PaymentIntent (KAN-861)
        api_response = api_instance.create_guest_donation(wt_guest_donation_request)
        print("The response of InteractionsApi->create_guest_donation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InteractionsApi->create_guest_donation: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **wt_guest_donation_request** | [**WTGuestDonationRequest**](WTGuestDonationRequest.md)|  | 
