...
**last_name** | **object** |  | 
**email** | **object** |  | 
**business_classification** | [**BusinessClassificationNonProfit**](BusinessClassificationNonProfit.md) |  | 
**business_industry** | [**BusinessIndustryNOTFORPROFIT**](BusinessIndustryNOTFORPROFIT.md) |  | 
...
json = "{}"
# create an instance of A2PNonProfitSubmission from a JSON string
a2_p_non_profit_submission_instance = A2PNonProfitSubmission.from_json(json)
# print the JSON string representation of the object
print A2PNonProfitSubmission.to_json()

# convert the object into a dict
a2_p_non_profit_submission_dict = a2_p_non_profit_submission_instance.to_dict()
# create an instance of A2PNonProfitSubmission from a dict
a2_p_non_profit_submission_form_dict = a2_p_non_profit_submission.from_dict(a2_p_non_profit_submission_dict)
```
